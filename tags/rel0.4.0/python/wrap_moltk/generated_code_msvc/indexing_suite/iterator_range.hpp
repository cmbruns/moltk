...
# define BOOST_MAKE_ITERATOR_RANGE       ::boost::python::indexing::make_iterator_range

#else
  // For compilers that can't deduce template argument array bounds
# define BOOST_MAKE_ITERATOR_RANGE(array)       ::boost::python::indexing::make_iterator_range (           (array), ((array) + sizeof(array) / sizeof((array)[0])))
#endif
